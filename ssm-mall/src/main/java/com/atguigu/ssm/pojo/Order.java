...
public class Order {
    ...
    public Order(Integer uid, String orderCode, BigDecimal sum, Integer totalNumber, String address, String post, String receiver, String mobile, String userMessage, Date createDate, Date payDate, Date deliverDate, Date confirmDate, String status) {
        this.uid = uid;
